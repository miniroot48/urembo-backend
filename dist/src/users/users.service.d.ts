...
export declare class UsersService {
    ...
    updateProfile(id: string, updateData: UpdateProfileDto): Promise<{
        id: string;
        email: string;
        fullName: string;
        phone: string;
    ...
    getAllUsers(role?: user_role, page?: number, limit?: number): Promise<{
        users: {
            id: string;
            email: string;
            fullName: string;
    ...
    suspendUser(id: string, suspendedBy: string, reason: string): Promise<{
        id: string;
        email: string;
        password: string;
        fullName: string | null;
    ...
    updateOnboardingStatus(id: string, status: onboarding_status): Promise<{
        id: string;
        email: string;
        password: string;
        fullName: string | null;
    ...
    updatePaymentDetails(id: string, paymentAccountDetails: any, paymentAccountType: string): Promise<{
        id: string;
        email: string;
        password: string;
        fullName: string | null;
    ...
    getUsersByRole(role: user_role, page?: number, limit?: number): Promise<{
        users: {
            id: string;
            email: string;
            fullName: string;
    ...
    getUsersByOnboardingStatus(status: onboarding_status, page?: number, limit?: number): Promise<{
        users: {
            id: string;
            email: string;
            fullName: string;
