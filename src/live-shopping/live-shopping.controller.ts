...
export class LiveShoppingController {
  ...
  async createSession(
    ...
    return this.liveShoppingService.createSession(createSessionDto, req.user.sub);
  }
  ...
  async deleteSession(
    ...
    return this.liveShoppingService.deleteSession(id, req.user.sub, req.user.role);
  }
  ...
  async addProductToSession(
    ...
    return this.liveShoppingService.addProductToSession(sessionId, productId, req.user.sub, req.user.role);
  }
  ...
  async removeProductFromSession(
    ...
    return this.liveShoppingService.removeProductFromSession(sessionId, productId, req.user.sub, req.user.role);
  }

  // Feature a product in session
  @Put('sessions/:sessionId/products/:productId/feature')
  @UseGuards(JwtAuthGuard)
  async featureProduct(
    ...
    return this.liveShoppingService.featureProduct(sessionId, productId, req.user.sub, req.user.role);
  }
  ...
  async getSessionMessages(
    ...
    return this.liveShoppingService.getSessionMessages(sessionId, pageNum, limitNum);
  }
  ...
  async getUserSessions(
    ...
    return this.liveShoppingService.getUserSessions(req.user.sub, req.user.role, pageNum, limitNum);
  }
  ...
  async getLiveShoppingStats(@Request() req) {
    return this.liveShoppingService.getLiveShoppingStats(req.user.sub, req.user.role);
  }
  ...
  async searchSessions(
    ...
    return this.liveShoppingService.searchSessions(query, req.user.sub, req.user.role);
  }
}
